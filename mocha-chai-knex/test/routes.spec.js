...
describe('API Routes', function() {
  ...
  // Test for getting all shows route
  ...
  // Test for getting one show by id
  describe('GET /api/v1/shows/:id', function() {
    it('should return a single show', function(done) {
      ...
      .end(function(err, res) {
        res.should.have.status(200);
        res.should.be.json; //jshit ignore:line
  ...
  // Test for posting a new show to DB
...
// Test for PUT route to edit a show in DB
...
// });
  ...
  // Experimental test for testing the incompatible ids
  // *** Notice the double callback when running this experiment
  describe('PUT /api/v1/shows/:id', function() {
  it('should update a show', function(done) {
    chai.request(server)
    .put('/api/v1/shows/1')
